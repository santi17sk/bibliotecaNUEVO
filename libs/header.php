...
<header class="style__site">
        <div class="contenedor">
            ...
            <div class="links__secundarios">
                <a href="/biblioteca/index.php"><i class="fas fa-home"></i> Inicio</a>
                <a href="#"><i class="fas fa-chevron-circle-down"></i> Categorías</a>
                <a href="#"><i class="fab fa-weixin"></i> Contacto</a>
