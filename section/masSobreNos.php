...
<main class="contenedor inicio">
    ...
    <div class="columnas__girs--7-3">
        ...
        <div class="detalles">
            ...
            <p>Este Servicio es general, centralizado y sus fondos son de libre acceso y de depósito.</p>
            <p>La Biblioteca tiene todos sus procesos automatizados, accediendo a la información bibliográfica a través del OPAC (Catálogo en Línea de Acceso Público).</p>
        </div>
    </div>
</main>
